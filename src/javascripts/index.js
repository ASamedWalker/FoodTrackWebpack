...
const API = new Wrapper("https://firestore.googleapis.com/v1/projects/foodtracker-6ac5c/databases/(default)/documents/food");
...
const init = () => {
    API.get("/?pageSize=100").then(data => {
        ...
        displayEntry(fields.name.stringValue, 
